...
ActiveRecord::Schema.define(version: 20140602223833) do
  ...
  add_index "multimedia", ["pin_id"], name: "index_multimedia_on_pin_id", using: :btree
  ...
  add_index "pins", ["type_id"], name: "index_pins_on_type_id", using: :btree
